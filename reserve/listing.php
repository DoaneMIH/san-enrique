...
<div class="container py-5">
  <div class="row g-4">
    ...
    <div class="col-lg-8">
      <!-- Featured Image -->
      <img src="<?= $listing['featured_image'] ?: 'https://placehold.co/1200x600/1b4332/ffffff?text='.urlencode($listing['name']) ?>"
    ...
    <div class="col-lg-4">
      ...
      <div class="listing-info-box mb-4" style="position:sticky;top:90px;">
        ...
        <div class="info-row">
          <i class="fas fa-envelope ir-icon"></i>
          <div class="ir-label">Email</div>
          <div class="ir-value"><a href="mailto:<?= htmlspecialchars($listing['email']) ?>" style="color:var(--primary-mid);"><?= htmlspecialchars($listing['email']) ?></a></div>
        </div>
        <?php endif; ?>
...
<script>
function initMap() {
  initDetailMap(<?= $listing['latitude'] ?>, <?= $listing['longitude'] ?>, '<?= addslashes($listing['name']) ?>');
}
</script>
