...
<meta name="description" content="Discover the hidden paradise of San Enrique, Iloilo. Explore resorts, cultural sites, local food, and beautiful barangays.">
      ...
      <div class="col-lg-6">
        <div class="hero-content">
          ...
          <p class="hero-subtitle">
            Your all-in-one guide to resorts, cultural heritage, local cuisine, agri-tourism, and vibrant barangays. Explore San Enrique like never before.
          </p>
          ...
          <div class="hero-stats">
            <div class="hero-stat">
              <div class="stat-num"><span class="count-up" data-target="<?= $stats['listings'] ?>"><?= $stats['listings'] ?></span>+</div>
              <div class="stat-label">Destinations</div>
            </div>
            <div class="hero-stat">
              <div class="stat-num"><span class="count-up" data-target="<?= $stats['categories'] ?>"><?= $stats['categories'] ?></span></div>
              <div class="stat-label">Categories</div>
            </div>
            <div class="hero-stat">
              <div class="stat-num"><span class="count-up" data-target="<?= $stats['barangays'] ?>"><?= $stats['barangays'] ?></span>+</div>
              <div class="stat-label">Barangays</div>
            </div>
            <div class="hero-stat">
              <div class="stat-num"><span class="count-up" data-target="<?= $stats['events'] ?>"><?= $stats['events'] ?></span></div>
      ...
      <div class="col-lg-6">
        <div class="hero-map-preview" style="position:relative;">
          <iframe
            ...
            width="100%"
            height="420"
            style="border:0;display:block;border-radius:var(--radius-lg);"
            allowfullscreen=""
            loading="lazy"
          ...
          <a href="map.php"
             style="position:absolute;bottom:1.2rem;left:50%;transform:translateX(-50%);
...
<section id="categories" class="categories-section">
  <div class="container">
    <div class="text-center mb-5 animate-on-scroll">
      ...
      <p class="section-subtitle mx-auto">From pristine beaches to heritage sites, discover everything San Enrique has to offer.</p>
    </div>
    <div class="row g-4 align-items-stretch">
      ...
      <div class="col-6 col-md-4 col-lg-2 animate-on-scroll delay-<?= ($i % 4) + 1 ?>">
        <div class="category-card" data-slug="<?= htmlspecialchars($cat['slug']) ?>" role="button"
          ...
          <div class="cat-icon" style="background: linear-gradient(135deg, <?= htmlspecialchars($cat['color']) ?>, <?= htmlspecialchars($cat['color']) ?>88);flex-shrink:0;">
            <i class="<?= htmlspecialchars($cat['icon']) ?>"></i>
          </div>
          <div class="cat-name" style="min-height:2.8em;display:flex;align-items:center;justify-content:center;"><?= htmlspecialchars($cat['name']) ?></div>
    ...
    <div class="row align-items-center g-5 mb-4">
      <div class="col-lg-6 animate-on-scroll">
        ...
        <p class="section-subtitle mb-3">
          Our Google Maps integration pins every resort, barangay, cultural site, and food spot. Filter by category and get real-time directions in one click.
        </p>
    ...
    <div class="row g-0">
      <div class="col-6 col-md-3">
        <div class="stat-card animate-on-scroll">
          ...
          <div class="stat-number"><span class="count-up" data-target="<?= $stats['listings'] ?>"><?= $stats['listings'] ?></span>+</div>
      ...
      <div class="col-6 col-md-3">
        <div class="stat-card animate-on-scroll delay-1">
          ...
          <div class="stat-number"><span class="count-up" data-target="<?= $stats['barangays'] ?>"><?= $stats['barangays'] ?></span></div>
      ...
      <div class="col-6 col-md-3">
        <div class="stat-card animate-on-scroll delay-2">
          ...
          <div class="stat-number"><span class="count-up" data-target="<?= $stats['events'] ?>"><?= $stats['events'] ?></span></div>
      ...
      <div class="col-6 col-md-3">
        <div class="stat-card animate-on-scroll delay-3">
          ...
          <div class="stat-number"><span class="count-up" data-target="<?= $stats['categories'] ?>"><?= $stats['categories'] ?></span></div>
    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-5 animate-on-scroll">
        <div class="about-img-wrap">
          ...
          <div class="about-highlight">
            <div style="font-size:0.75rem;color:var(--text-muted);text-transform:uppercase;letter-spacing:0.08em;margin-bottom:4px;">LGU Initiative</div>
            <div style="font-family:'Playfair Display',serif;font-size:1.1rem;color:var(--primary);font-weight:700;">Digital Tourism Platform</div>
      ...
      <div class="col-lg-7 animate-on-scroll delay-2">
        ...
        <p style="color:var(--text-muted);margin-bottom:1.5rem;line-height:1.8;">
          San Enrique is a municipality in the province of Iloilo, Philippines, known for its warm hospitality, rich cultural heritage, and breathtaking natural landscapes. This digital platform is an initiative by the Local Government Unit to promote local tourism and support the community.
        </p>
        <ul class="feature-list">
          <li>
            ...
            <div>
              ...
              <span style="color:var(--text-muted);font-size:0.88rem;">Every listing is pinned with precise GPS coordinates for easy navigation and real-time directions.</span>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <span style="color:var(--text-muted);font-size:0.88rem;">Supporting sustainable tourism with organic farms, eco-trails, and community-led experiences.</span>
            </div>
          </li>
          <li>
            ...
            <div>
              ...
              <span style="color:var(--text-muted);font-size:0.88rem;">Historic churches, traditional festivals, and vibrant local arts celebrating Visayan culture.</span>
            </div>
          </li>
        </ul>
    ...
    <div class="row g-4">
      <div class="col-lg-4 animate-on-scroll">
        <div class="contact-info-card">
          <h4 style="font-family:'Playfair Display',serif;color:white;font-size:1.2rem;margin-bottom:2rem;">Tourism Office Information</h4>
      ...
      <div class="col-lg-8 animate-on-scroll delay-2">
        <div class="contact-form-wrap">
          <h4 style="font-family:'Playfair Display',serif;color:var(--primary);font-size:1.2rem;margin-bottom:1.75rem;">Send Us a Message</h4>
          <form id="contactForm">
            <div class="row g-3">
              <div class="col-md-6">
              ...
              <div class="col-12">
                ...
                <input type="text" name="subject" class="form-control-main" placeholder="Inquiry about San Enrique Tourism" required>
              </div>
              <div class="col-12">
                <label class="form-label-main">Message *</label>
                <textarea name="message" class="form-control-main" rows="5" placeholder="Tell us how we can help you..." required style="resize:vertical;"></textarea>
              </div>
              <div class="col-12">
    ...
    <div class="row g-5">
      <div class="col-lg-4">
        <div class="footer-logo">
          <div class="d-flex align-items-center gap-3">
            <div class="brand-logo" style="width:44px;height:44px;background:linear-gradient(135deg,#52b788,#d4a017);border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.4rem;flex-shrink:0;">🌿</div>
            <div>
              <div style="font-family:'Playfair Display',serif;color:white;font-size:1.1rem;font-weight:700;">San Enrique Tourism Hub</div>
              <div style="font-size:0.7rem;color:rgba(255,255,255,0.4);text-transform:uppercase;letter-spacing:0.08em;">Official LGU Tourism Platform</div>
            </div>
          </div>
        </div>
        <p class="footer-desc">
          Your official digital gateway to the beauty, culture, and hospitality of San Enrique, Iloilo. A proud initiative of the San Enrique Local Government Unit.
        </p>
      ...
      <div class="col-6 col-lg-2">
        ...
        <ul class="footer-links">
          <?php foreach ($categories as $cat): ?>
          <li><a href="explore.php?category=<?= htmlspecialchars($cat['slug']) ?>"><i class="fas fa-chevron-right"></i> <?= htmlspecialchars($cat['name']) ?></a></li>
          <?php endforeach; ?>
        </ul>
      </div>
      ...
      <div class="col-lg-4">
        ...
        <div style="display:flex;flex-direction:column;gap:0.9rem;">
          <div style="display:flex;gap:10px;align-items:flex-start;">
            ...
            <span style="font-size:0.85rem;color:rgba(255,255,255,0.5);">Municipal Hall, Poblacion, San Enrique, Iloilo</span>
          </div>
