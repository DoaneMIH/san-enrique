    ...
    <div class="row g-4">
        ...
        <div class="admin-form-card">
          <div class="admin-form-header">
            <div style="display:flex;align-items:center;gap:10px;">
              <div style="width:40px;height:40px;background:linear-gradient(135deg,var(--primary),var(--accent));border-radius:12px;display:flex;align-items:center;justify-content:center;color:white;font-size:1.1rem;">
                <i class="fas fa-user"></i>
              </div>
              <div>
                <div style="font-family:'Playfair Display',serif;font-size:1.05rem;color:var(--primary);">Profile Information</div>
          ...
          <form method="POST" action="">
            ...
            <div class="admin-form-body" style="display:flex;flex-direction:column;gap:1rem;">
              ...
              <div style="text-align:center;padding:1rem;background:var(--content-bg);border-radius:12px;">
                <div style="width:72px;height:72px;background:linear-gradient(135deg,var(--primary),var(--accent));border-radius:20px;display:flex;align-items:center;justify-content:center;color:white;font-weight:700;font-size:2rem;margin:0 auto 0.75rem;">
                  <?= strtoupper(substr($adminInfo['full_name'], 0, 1)) ?>
                </div>
                <div style="font-family:'Playfair Display',serif;font-size:1rem;color:var(--primary);font-weight:700;"><?= htmlspecialchars($adminInfo['full_name']) ?></div>
              ...
              <div>
                ...
                <input type="text" class="admin-input" value="<?= htmlspecialchars($adminInfo['username']) ?>" disabled
                       style="background:var(--content-bg);cursor:not-allowed;color:var(--text-muted);">
                <div style="font-size:0.75rem;color:var(--text-muted);margin-top:4px;"><i class="fas fa-info-circle me-1"></i>Username cannot be changed.</div>
              </div>
              <div>
      ...
      <div class="col-lg-6">
        <div class="admin-form-card">
          <div class="admin-form-header">
            <div style="display:flex;align-items:center;gap:10px;">
              <div style="width:40px;height:40px;background:linear-gradient(135deg,#b7791f,#d4a017);border-radius:12px;display:flex;align-items:center;justify-content:center;color:white;font-size:1.1rem;">
                <i class="fas fa-lock"></i>
              </div>
              <div>
                <div style="font-family:'Playfair Display',serif;font-size:1.05rem;color:var(--primary);">Change Password</div>
            ...
            <div class="admin-form-body" style="display:flex;flex-direction:column;gap:1rem;">
              <div>
                ...
                <div style="position:relative;">
                  <input type="password" name="current_password" class="admin-input" id="cp" required placeholder="Enter current password">
                  <button type="button" onclick="togglePw('cp','eye1')" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:var(--text-muted);">
              ...
              <div>
                ...
                <div style="position:relative;">
                  <input type="password" name="new_password" class="admin-input" id="np" required placeholder="At least 6 characters" oninput="checkStrength(this.value)">
                  <button type="button" onclick="togglePw('np','eye2')" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:var(--text-muted);">
              ...
              <div>
                ...
                <div style="position:relative;">
                  <input type="password" name="confirm_password" class="admin-input" id="cnp" required placeholder="Repeat new password">
                  <button type="button" onclick="togglePw('cnp','eye3')" style="position:absolute;right:10px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:var(--text-muted);">
        ...
        <div class="admin-form-card" style="margin-top:1.25rem;">
          ...
          <div class="admin-form-body">
            ...
            ?>
            <div style="display:flex;justify-content:space-between;padding:0.65rem 0;border-bottom:1px solid var(--border);font-size:0.86rem;">
          ...
          <div class="admin-form-body">
            <div class="row g-3">
              ...
              <div class="col-md-6 col-lg-3">
                <div style="background:var(--content-bg);border-radius:12px;padding:1.25rem;border:1px solid var(--border);height:100%;">
                  <div style="display:flex;align-items:center;gap:10px;margin-bottom:0.75rem;">
                    <div style="width:36px;height:36px;background:<?= $color ?>;border-radius:10px;display:flex;align-items:center;justify-content:center;color:white;font-size:0.9rem;flex-shrink:0;">
                      <i class="<?= $icon ?>"></i>
                    </div>
                    <div>
                      <div style="font-size:0.68rem;color:var(--text-muted);text-transform:uppercase;letter-spacing:0.08em;">Step <?= $num ?></div>
