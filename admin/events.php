...
<body>
          ...
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="admin-form-body">
              <div class="row g-3">
                ...
                <!-- Barangay-only fields — shown via JS when category = barangays -->
                <div id="brgyExtraFields" class="col-12 brgy-extra-fields" style="display:none;">
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      var sel = document.querySelector('select[name="category_id"]');
      if (sel) {
        sel.addEventListener('change', updateBrgyFields);
        updateBrgyFields(); // run on load for edit mode
      }
    });
