                ...
                <div>
                  ...
                  <div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:8px;">
                    <?php foreach ($iconSuggestions as $ico): ?>
                      <button type="button" onclick="setIcon('<?= $ico ?>')" title="<?= $ico ?>"
                  ...
                  <div style="margin-top:8px;display:flex;align-items:center;gap:10px;">
                    <div id="iconPreview"
                      style="width:44px;height:44px;border-radius:12px;background:var(--primary);display:flex;align-items:center;justify-content:center;color:white;font-size:1.2rem;">
                  ...
                  <?php foreach ($categories as $cat): ?>
                    <tr>
                      <td>
                        <div style="display:flex;align-items:center;gap:10px;">
                          <div
                            style="width:38px;height:38px;border-radius:10px;background:<?= htmlspecialchars($cat['color']) ?>;display:flex;align-items:center;justify-content:center;color:white;font-size:1rem;">
                            <i class="<?= htmlspecialchars($cat['icon']) ?>"></i>
                          </div>
                          <span
                            style="font-weight:700;color:var(--primary);font-size:0.9rem;"><?= htmlspecialchars($cat['name']) ?></span>
                        </div>
                      </td>
                      <td style="font-size:0.8rem;color:var(--text-muted);font-family:monospace;">
                        <?= htmlspecialchars($cat['slug']) ?></td>
                      <td style="font-size:0.8rem;color:var(--text-muted);font-family:monospace;">
                        <?= htmlspecialchars($cat['icon']) ?></td>
                      <td>
                        <div style="display:flex;align-items:center;gap:6px;">
                          <div
                            style="width:20px;height:20px;border-radius:5px;background:<?= htmlspecialchars($cat['color']) ?>;border:1px solid rgba(0,0,0,0.1);">
                          </div>
                          <span
                            style="font-size:0.8rem;color:var(--text-muted);font-family:monospace;"><?= htmlspecialchars($cat['color']) ?></span>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div style="display:flex;gap:6px;">
                          ...
                          <?php else: ?>
                            <button disabled title="Has listings"
                              style="background:rgba(0,0,0,0.04);color:var(--gray-500);border:1px solid var(--border);border-radius:7px;padding:0.5rem 0.9rem;font-size:0.82rem;cursor:not-allowed;">
